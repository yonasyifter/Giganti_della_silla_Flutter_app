  ...
  Widget build(BuildContext context) {
    final actions = [
      ...
      _Action(Icons.cloud_rounded, l.navWeather, AppColors.info,
          () => context.go('/weather')),
      _Action(Icons.directions_walk_rounded, l.navTracking,
          const Color(0xFF00BCD4), () => context.push('/tracking')),
      _Action(Icons.menu_book_rounded, l.navGuide,
          const Color(0xFFFF9800), () => context.push('/guide')),
      _Action(Icons.local_parking_rounded, l.navParking,
          const Color(0xFF9C27B0), () => context.push('/parking')),
